...
const {isAuthenticated,isGuest,noCache, isBlocked}=require('../../middlewares/auth.middlewares')
const shopCtlr=require('../../controllers/usercontroller/shop.controller')
const {getCart,addToCart,removeFromCart,updateQuantity}=require('../../controllers/usercontroller/cart.controller')
const {addToWishlist,getWishlist,removeFromwishlist}=require('../../controllers/usercontroller/wishlist.controller')
const {getCheckout,placeOrder,getSuccessPage,verifyPayment,rePayment,addMoneyToWallet,walletVerifyPayment}=require('../../controllers/usercontroller/checkout.controller')
const {getProfile,addAddress,getOrders,requestReturnOrder,returnItem,
    ...
    changePassword}=require('../../controllers/usercontroller/address.controller')
const {getWallet}= require('../../controllers/usercontroller/wallet.controller')
